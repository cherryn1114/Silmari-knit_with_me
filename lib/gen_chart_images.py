...
def create_icon_png(key: str, name_en: str) -> str:
    ...
    # 중앙 약어
    w, h = get_text_size(draw, key, font_big)
    draw.text(
    ...
    # 아래 영문 이름
    if name_en:
        w2, h2 = get_text_size(draw, name_en, font_small)
        draw.text(
...
def main():
    ...
    for key, item in merged.items():
        ...
        fname = create_icon_png(key, item.get("name_en", ""))
        count += 1
